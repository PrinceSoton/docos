...
@section('content')
    <div class="space-y-4 sm:space-y-5">
        <div data-aos="fade-down">
            ...
            <p class="text-sm text-slate-500">Publications partagées par l'administration</p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5" id="evtGrid">
                ...
                <div class="card overflow-hidden evt-card hover:shadow-xl transition-all hover:-translate-y-1 duration-300"
                    ...
                    <div class="p-4 sm:p-5">
                        ...
                        @if ($evt->date_evenement)
                            <p class="text-xs text-indigo-600 font-medium mt-2"><i
                                    class="fas fa-calendar mr-1"></i>{{ $evt->date_evenement->format('d/m/Y à H:i') }}</p>
                        @endif
