...
@section('content')
    <div class="space-y-4 sm:space-y-5">
        <div data-aos="fade-down">
            ...
            <p class="text-sm text-slate-500">{{ $attestations->total() }} demande(s) de vos stagiaires</p>
        </div>
                    ...
                    <tbody class="divide-y divide-slate-50" id="attTable">
                        @forelse($attestations as $att)
                            <tr class="hover:bg-slate-50 transition att-row" data-statut="{{ $att->statut }}">
                                ...
                                <td class="px-4 sm:px-5 py-4 text-slate-400 text-xs hidden sm:table-cell">
                                    {{ $att->created_at->format('d/m/Y') }}</td>
                                <td class="px-4 sm:px-5 py-4">
