    ...
    <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div class="w-full max-w-md relative z-10" data-aos="fade-up">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-indigo-300 text-sm mt-1">Nouveau mot de passe</p>
            </div>

            <!-- Carte -->
            <div class="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-8 shadow-2xl">
                <h2 class="text-white font-bold text-xl mb-1 text-center">Définir un nouveau mot de passe</h2>
                <p class="text-indigo-300 text-sm text-center mb-6">Choisissez un mot de passe sécurisé.</p>
                ...
                <form method="POST" action="{{ route('password.update') }}" class="no-loader">
                    @csrf
                    <!-- Token -->
                    ...
                    <div class="mb-6">
                        <label class="block text-indigo-200 text-sm font-medium mb-2">
                            <i class="fas fa-check-circle mr-2"></i>Confirmer le mot de passe
                        </label>
                        <div class="relative">
