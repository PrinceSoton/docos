...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333333; margin: 0; padding: 20px;">
    ...
    <h2>Bienvenue {{ $stagiaire['nom'] }}</h2>

    <p>Votre compte stagiaire a bien été créé au sein de l'entreprise <strong> Nextmux</strong>. Votre identifiant de
        connexion est
        <strong>{{ $stagiaire['email'] }}</strong>. Votre mot de passe est <strong>{{ $password }}</strong>. Nous
        vous recommandons de le changer dès votre première connexion.
    </p>
