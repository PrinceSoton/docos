            ...
            <form action="{{ route('admin.attestations.upload', $attestation) }}" method="POST"
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2"><i
                            class="fas fa-file mr-1 text-indigo-500"></i>Document à envoyer * <span
                            class="text-slate-400 font-normal">(PDF, DOC, DOCX, JPG, PNG...)</span></label>
                    <div class="border-2 border-dashed border-slate-200 rounded-2xl p-6 sm:p-8 text-center hover:border-green-400 transition cursor-pointer"
                        id="dropZone">
                        ...
                        <div id="dropContent">
                            ...
                            <p class="text-slate-500 text-sm font-medium">Glissez le document ici ou <span
                                    class="text-green-600 hover:underline">parcourez</span></p>
